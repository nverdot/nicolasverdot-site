...
export const conversations: Conversation[] = [
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Marc', text: 'Grave. On a refait le même débat que la dernière fois', time: '18:42', reactOn: 0, reactions: [{ emoji: '😂', count: 2 }, { emoji: '🤣', count: 1 }] },
      ...
      { kind: 'msg', name: 'Julie', text: "On ressort avec un plan d'action... qu'on n'ouvrira jamais 😅", time: '18:44', reactOn: 2, reactions: [{ emoji: '👍', count: 1 }, { emoji: '👏', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Vincent', text: "Et après on fait semblant de nous demander notre avis sur un truc déjà décidé", time: '14:03', reactOn: 0, reactions: [{ emoji: '🙄', count: 3 }, { emoji: '😑', count: 1 }] },
      ...
      { kind: 'msg', name: 'Thibault', text: "Ils vont même nous envoyer un questionnaire de satisfaction après 😂", time: '14:06', reactOn: 2, reactions: [{ emoji: '😂', count: 1 }, { emoji: '👏', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Emma', text: "Et 2 personnes en moins dans l'équipe depuis janvier", time: '09:13', reactOn: 0, reactions: [{ emoji: '😩', count: 3 }, { emoji: '😮‍💨', count: 2 }] },
      ...
      { kind: 'msg', name: 'Chloe', text: 'Faire plus avec moins... on connaît la chanson 🎶', time: '09:16', reactOn: 2, reactions: [{ emoji: '💯', count: 2 }, { emoji: '🔥', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Lea', text: 'Bienvenue au club. Mon agenda ressemble à un Tetris', time: '17:21', reactOn: 0, reactions: [{ emoji: '😩', count: 3 }, { emoji: '😅', count: 1 }] },
      ...
      { kind: 'msg', name: 'Manon', text: 'Ou un email de 3 lignes... qu\'on lirait vraiment', time: '17:24', reactOn: 2, reactions: [{ emoji: '💀', count: 2 }, { emoji: '😂', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Theo', text: 'Il est où déjà ? Quelque part dans le drive ?', time: '11:06', reactOn: 0, reactions: [{ emoji: '😂', count: 2 }, { emoji: '📁', count: 1 }] },
      ...
      { kind: 'msg', name: 'Maxime', text: 'Classique. On décide, on note, on oublie', time: '11:09', reactOn: 2, reactions: [{ emoji: '🙃', count: 1 }, { emoji: '✅', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Romain', text: 'Nous aussi on a un projet similaire de notre côté. Personne ne le savait', time: '10:32', reactOn: 0, reactions: [{ emoji: '😑', count: 3 }, { emoji: '🤦', count: 2 }] },
      ...
      { kind: 'msg', name: 'Jade', text: 'Bonne idée. On en discute... en réunion à part 😅', time: '10:35', reactOn: 2, reactions: [{ emoji: '😂', count: 1 }, { emoji: '🎯', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Sarah', text: 'T\'as pensé à en parler à quelqu\'un ? Toi aussi t\'as le droit de souffler', time: '19:42', reactOn: 0, reactions: [{ emoji: '🫂', count: 3 }, { emoji: '❤️', count: 1 }] },
      ...
      { kind: 'msg', name: 'Lina', text: 'On devrait plus l\'épauler franchement', time: '19:45', reactOn: 2, reactions: [{ emoji: '😔', count: 2 }, { emoji: '💯', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Nina', text: 'Team building le vendredi, tensions le lundi, comme d\'hab', time: '20:16', reactOn: 0, reactions: [{ emoji: '😂', count: 2 }, { emoji: '🎯', count: 1 }] },
      ...
      { kind: 'msg', name: 'Margaux', text: 'Le prochain, on pourrait peut-être... parler du travail ? 😅', time: '20:19', reactOn: 2, reactions: [{ emoji: '🙈', count: 1 }, { emoji: '👏', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Emy', text: 'On venait juste de s\'organiser autour de la précédente', time: '08:57', reactOn: 0, reactions: [{ emoji: '😵‍💫', count: 3 }, { emoji: '🌀', count: 1 }] },
      ...
      { kind: 'msg', name: 'Oceane', text: 'Une vraie priorité, c\'est justement celle qui ne bouge pas', time: '09:00', reactOn: 2, reactions: [{ emoji: '😂', count: 3 }, { emoji: '🎯', count: 2 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Lucie', text: 'Pareil. Perso je garde ça pour la machine à café', time: '15:11', reactOn: 0, reactions: [{ emoji: '🙈', count: 3 }, { emoji: '😅', count: 1 }] },
      ...
      { kind: 'msg', name: 'Juliette', text: 'Ça changerait beaucoup de réunions franchement', time: '15:14', reactOn: 2, reactions: [{ emoji: '👀', count: 2 }, { emoji: '💯', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Eva', text: 'On lui a filé un vieux doc de 2019 en guise de formation', time: '13:21', reactOn: 0, reactions: [{ emoji: '😂', count: 2 }, { emoji: '📄', count: 1 }] },
      ...
      { kind: 'msg', name: 'Louna', text: 'Sympa comme première impression de l\'entreprise...', time: '13:24', reactOn: 2, reactions: [{ emoji: '😬', count: 1 }, { emoji: '🫠', count: 1 }] },
    ],
    insight: {
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'msg', name: 'Elise', text: 'On a arrêté de s\'investir à fond dès la 2e, perso', time: '16:46', reactOn: 0, reactions: [{ emoji: '😮‍💨', count: 3 }, { emoji: '🔁', count: 2 }] },
      ...
      { kind: 'msg', name: 'Anais', text: 'Personne n\'a le temps de tirer les leçons avant la suivante', time: '16:49', reactOn: 2, reactions: [{ emoji: '😩', count: 2 }, { emoji: '🎢', count: 1 }] },
    ],
    insight: {
