...
export const priorities: Priority[] = [
  ...
  { title: 'Rendre une réflexion collective visible et mémorable', text: "Traduire en direct vos séminaires, ateliers ou conférences en fresques visuelles qui aident à comprendre, se souvenir et embarquer ceux qui n'étaient pas là.", href: withBase('/offres/capture-graphique/') },
];
